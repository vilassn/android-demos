...
public class ProductItemListAdapter extends ArrayAdapter<Item> {

    private final Activity context;
    private final List<Item> itemList;

    public ProductItemListAdapter(Activity context, List<Item> items) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.product_listview_item, null, true);
        ...
        Button btnAdd= rowView.findViewById(R.id.add);
        ...
        btnAdd.setOnClickListener((v -> System.out.println("Add button is pressed...!")));
